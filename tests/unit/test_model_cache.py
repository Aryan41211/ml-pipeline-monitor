...
from ml_pipeline_monitor.ml.model_cache import (
    clear_cache,
...
@patch("ml_pipeline_monitor.ml.model_cache._resolve_artifact")
@patch("joblib.load")
...
@patch("ml_pipeline_monitor.database.get_latest_production_model")
@patch("ml_pipeline_monitor.ml.model_cache.get_model")
